...
public class Xml2JsonUtil {
    ...
    private static Map  iterateElement(Element element) {  
        ...
        obj.put("attributes", attributeMap);
        }
...
//                + "</MapSet>")); 
        JSONObject  request = JSONObject.fromObject(Xml2JsonUtil.xml2JSON(new File("D:\\play_ok.xml")));
        JSONObject  Busap = JSONObject.fromObject(request.get("Busap"));
        JSONObject  attributes = JSONObject.fromObject(Busap.get("attributes"));
        System.out.println(attributes.get("createTime"));
    }  
}
